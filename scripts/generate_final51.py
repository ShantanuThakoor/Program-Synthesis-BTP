...
f1 = open('../training/input81.xml','w')
f2 = open('../training/output81.xml','w')
...
f1 = open('../ranking/input81.xml','w')
f2 = open('../ranking/output81.xml','w')
...
while j < rank_examples*impurity_rank_unseen:
	...
	if(size != 10 and size != 8):
		...
		out = "<textbox>\n";
		for i in textlist:
			out = out + "<para text=\""+i+"\" font=\"Times New Roman\" size=\""+str(10)+"\" style=\"bold\"></para>\n"
		out = out + "</textbox>\n"
...
f1 = open('../test/input81.xml','w')
f2 = open('../test/output81.xml','w')
