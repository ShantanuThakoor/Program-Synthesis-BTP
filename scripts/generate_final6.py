...
f1 = open('../training/input9.xml','w')
f2 = open('../training/output9.xml','w')
...
f1 = open('../ranking/input9.xml','w')
f2 = open('../ranking/output9.xml','w')
...
f1 = open('../test/input9.xml','w')
f2 = open('../test/output9.xml','w')
