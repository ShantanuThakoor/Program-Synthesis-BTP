...
fonts = ['Comic_Sans','Arial','Times_New_Roman','Arial_Bold']
sizes = [1,2,3,4,5,6,8,10,12,14,16,18,20]
colors = ['red','blue','green','yellow','black']

######################################################################

f1 = open('../training/input201.xml','w')
f2 = open('../training/output201.xml','w')
...
while j < impurity_train*train_examples:
	...
	if(font == "Arial"):
		unique.append(1)
	if(font == "Times_New_Roman" and color=="blue"):
		unique.append(2)
...
f1 = open('../ranking/input201.xml','w')
f2 = open('../ranking/output201.xml','w')
...
f1 = open('../test/input201.xml','w')
f2 = open('../test/output201.xml','w')
