...
f1 = open('../training/input51.xml','w')
f2 = open('../training/output51.xml','w')
...
f1 = open('../ranking/input51.xml','w')
f2 = open('../ranking/output51.xml','w')
...
f1 = open('../test/input51.xml','w')
f2 = open('../test/output51.xml','w')
